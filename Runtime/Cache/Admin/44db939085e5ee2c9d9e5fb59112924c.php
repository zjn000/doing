...
<div class="box">
    ...
    <form id="geetest" action="<?php echo U('Home/Index/webuploader');?>" method="post">
        <div id="upload-57e0e46e01bbd" class="xb-uploader">
    <div class="queueList">
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        pick: {
            id: "#upload-57e0e46e01bbd .filePicker",
            label: '点击选择文件',
            multiple : true
        },
        dnd: "#upload-57e0e46e01bbd .queueList",
        paste: document.body,
        // accept: {
        //     title: 'Images',
        ...
        chunked: true,
        server: "/doing/index.php/Home/Index/ajax_upload",
        fileNumLimit: 300,
    ...
    // 添加“添加文件”的按钮，
    uploader.addButton({
       id: "#upload-57e0e46e01bbd .filePicker2",
       label: '继续添加'
    });
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if (fileCount==stats.successNum && stats.successNum!=0) {
                $('#upload-57e0e46e01bbd .webuploader-element-invisible').remove();
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( "#upload-57e0e46e01bbd .filePicker2" ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( "#upload-57e0e46e01bbd .filePicker2" ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
...
<script>
    var BASE_URL = '/doing/Public/statics/webuploader-0.1.5';
</script>
