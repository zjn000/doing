        ...
        <div class="modal-content">
            <div class="bjy-top">
                <div class="bjy-t-myinfo">
                    ...
                    <img class="bjy-t-avatar" src="<?php echo get_url($_SESSION['user']['avatar']);?>">
                </div>
...
<script src="/doing/Public/statics/emoji/js/config.js"></script>
<script src="/doing/Public/statics/emoji/js/emoji-picker.js"></script>
<script src="/doing/Public/statics/emoji/js/jquery.emojiarea.js"></script>
...
<script src="/doing/Public/statics/rongcloud/js/main.js"></script>
